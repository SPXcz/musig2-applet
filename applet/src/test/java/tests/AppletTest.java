...
public class AppletTest extends BaseTest {
    ...
    public void testKeygenValues1() throws Exception {
        ...
        data.put("settings", new byte[] {Constants.STATE_TRUE, Constants.STATE_FALSE, Constants.STATE_FALSE});
    ...
    public void testNonceGen1 () throws Exception {
        ...
        HashMap<String, byte[]> data = new HashMap<>();
        data.put("settings", new byte[] {Constants.STATE_FALSE, Constants.STATE_TRUE, Constants.STATE_FALSE});
